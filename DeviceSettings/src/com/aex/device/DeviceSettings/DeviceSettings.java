...
*
*/
package com.aex.device.DeviceSettings;
...
import com.aex.device.DeviceSettings.ModeSwitch.DCModeSwitch;
import com.aex.device.DeviceSettings.ModeSwitch.HBMModeSwitch;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mFpsInfo) {
            ...
            Intent hbmIntent = new Intent(getContext(),
                    com.aex.device.DeviceSettings.HBMModeService.class);
