...
*
*/
package com.aex.device.DeviceSettings.ModeSwitch;

import android.content.Context;
import android.content.Intent;
import android.os.UserHandle;

import com.aex.device.DeviceSettings.Utils;

public class HBMModeSwitch {

    public static final String ACTION_HBM_SERVICE_CHANGED =
            "com.aex.device.DeviceSettings.ModeSwitch.HBM_SERVICE_CHANGED";
